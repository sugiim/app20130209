...
Event.create(team_id: "1", event_name: "練習試合", event_place: "等々力Aグランド",event_desc: "xxチームと練習試合です。xx交差点のすぐ近くに駐車場があります。30分前には集合してください。", event_date: dt, event_date_from: dt_f, event_date_to: dt_t)
...
Info.create(team_id: "1", info_desc: "もxx君が新しくチームに加入しました。△△君からの紹介です。", info_order: 2)
